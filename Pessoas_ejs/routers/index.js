// Importa o módulo 'pessoasRouter.js' e atribui à variável 'routerpessoass'
const routerpessoass = require("./pessoasRouter.js");
...
module.exports = function (app, express) {
  ...
  // Adiciona o roteador 'routerpessoass' (com as rotas definidas) ao aplicativo Express
  app.use(routerpessoass);
};